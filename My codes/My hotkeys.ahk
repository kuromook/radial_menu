...
MenuToShow := 51                    ; ... we will show menu for Paint (Gui number 56)
...
#+z::
IfWinActive, CLIP STUDIO PAINT ; if Paint is active window ...
MenuToShow := 52                    ; ... we will show menu for Paint (Gui number 56)
else IfWinActive, ahk_class 742DEA58-ED6B-4402-BC11-20DFC6D08040-6571DDC4-B3AA-45e4-9D35-57C0C1E90AD5                         ; in all other cases ...
MenuToShow := 52
else
MenuToShow := 99                ; ... we will show General menu (Gui number 58)
...
#a::
IfWinActive, CLIP STUDIO PAINT ; if Paint is active window ...
MenuToShow := 54                    ; ... we will show menu for Paint (Gui number 56)
else IfWinActive, ahk_class 742DEA58-ED6B-4402-BC11-20DFC6D08040-6571DDC4-B3AA-45e4-9D35-57C0C1E90AD5                         ; in all other cases ...
MenuToShow := 54
else
MenuToShow := 99                ; ... we will show General menu (Gui number 58)
...
#d::
IfWinActive, CLIP STUDIO PAINT ; if Paint is active window ...
MenuToShow := 55                    ; ... we will show menu for Paint (Gui number 56)
else IfWinActive, ahk_class 742DEA58-ED6B-4402-BC11-20DFC6D08040-6571DDC4-B3AA-45e4-9D35-57C0C1E90AD5                         ; in all other cases ...
MenuToShow := 55
else
MenuToShow := 99                ; ... we will show General menu (Gui number 58)
